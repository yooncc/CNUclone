...
$query = "SELECT title, contents, user_id, updated_time, file ,name from board1 where board_no = $number";
...
<form method="POST" action="modify_action1.php" enctype="multipart/form-data">
