...
$connect = pg_Connect("host=127.0.0.1 port=5432 dbname=yooncc user=yooncc password=40314031") or die("die");
...
$query = "INSERT INTO $btype (board_no, title, contents, user_id, created_time,updated_time, counts, file, name)
	values(1, '$title', '$content', '$id', now(),null, 0, '$o_name', '$name')";
...
<script>
	...
	//location.replace("<?php echo 'board4'?>.php");
</script>
<?php
} else {
