...
<head>
  ...
  <link rel="canonical" href="/clone/login.php" />
      ...
      <div class="top-header-wrap">
        <div class="top-header-box">
          <ul>
            ...
            <li>
              <a href="http://library.cnu.ac.kr/sso/index.jsp" title="새창열기" target="_blank" class="lib-btn">도서관</a>
            </li>
            <li>
            ...
            <li class="login">
              <a href="/math/etc/login.do">로그인</a>
            </li>

            <li>
              <a href="/math/etc/sitemap.do" title="사이트맵 바로가기" class="sitemap-btn">사이트맵</a>
            </li>
            <li>
      ...
      <div class="bottom-header-wrap">
        <div class="bottom-header-box">
          ...
          <div class="gnb">
            ...
            <ul class="gnb-ul">
              ...
              <li>
                <a href="/math/intro/intro.do">학과안내</a>

                <ul class="sub-mn">

                  <li><a href="/math/intro/intro.do">소개</a></li>
              ...
              <li>
                <a href="/math/people/faculty01.do">학과 사람들</a>

                <ul class="sub-mn">

                  <li><a href="/math/people/faculty01.do">교수소개</a></li>

                  <li><a href="/math/people/lecturer.do">시간강사 소개</a></li>

                  <li><a href="/math/people/student.do">대학원생 소개</a></li>

                  <li><a href="/math/people/council.do">학생회 소개</a></li>

                  <li><a href="/math/people/circles.do">동아리 소개</a></li>
              ...
              <li>
                <a href="/math/bachelor/calender-under.do">학사정보</a>

                <ul class="sub-mn">

                  <li><a href="/math/bachelor/calender-under.do">학사일정</a></li>

                  <li><a href="/math/bachelor/room.do">스터디룸</a></li>

                  <li><a href="/math/bachelor/curriculum-under.do">교육과정</a></li>

                  <li><a href="/math/bachelor/scholarship.do">발전기금 장학금안내</a></li>
              ...
              <li>
                <a href="/math/online/propose.do">자료실 / 온라인접수</a>

                <ul class="sub-mn">

                  <li><a href="/math/online/propose.do">취업신청</a></li>

                  <li><a href="/math/online/data.do">자료실</a></li>

                  <li><a href="/math/online/rooms.do">강의별 게시판</a></li>

                  <li><a href="/math/online/personel.do">정원외 수강신청</a></li>

                  <li><a href="/math/online/study.do">스터디룸신청 및 접수</a></li>

                  <li><a href="/math/online/scholarship.do">장학금신청 및 접수</a></li>

                  <li><a href="/math/online/lecturer.do">시간강사신청 및 접수</a></li>
        ...
        <nav class="slideMenu">
          <div class="m-util">
            <ul>
              <li>
                <a target="_blank" href="index.php">충남대학교</a>
              </li>
              <li class="app-btn"></li>
              <li>
          ...
          <div class="m-gnb">
            ...
            <ul class="dep1">
              ...
              <li>
                ...
                <ul class="dep2">
                  ...
                  <li>
                    ...
                    <a href="#5830_menu" class="depth02-active">소개</a>

                    <ul class="dep3">

                      <li><a href="/math/intro/intro.do">학과소개</a></li>

                      <li><a href="/math/intro/history.do">학과연혁</a></li>

                      <li><a href="/math/intro/location.do">찾아오시는 길</a></li>

                      <li><a href="/math/intro/plan.do">학과발전계획</a></li>
              ...
              <li>
                ...
                <ul class="dep2">
                  ...
                  <li>
                    ...
                    <a href="/math/people/faculty01.do">교수소개</a>
                  ...
                  <li>
                    ...
                    <a href="/math/people/lecturer.do">시간강사 소개</a>
                  ...
                  <li>
                    ...
                    <a href="/math/people/student.do">대학원생 소개</a>
                  ...
                  <li>
                    ...
                    <a href="/math/people/council.do">학생회 소개</a>
                  ...
                  <li>
                    ...
                    <a href="/math/people/circles.do">동아리 소개</a>
              ...
              <li>
                ...
                <ul class="dep2">
                  ...
                  <li>
                    ...
                    <a href="/math/bachelor/calender-under.do">학사일정</a>
                  ...
                  <li>
                    ...
                    <a href="/math/bachelor/room.do">스터디룸</a>
                  ...
                  <li>
                    ...
                    <a href="/math/bachelor/curriculum-under.do">교육과정</a>
                  ...
                  <li>
                    ...
                    <a href="#5839_menu" class="depth02-active">발전기금 장학금안내</a>

                    <ul class="dep3">

                      <li><a href="#noMenu">교수장학금</a></li>

                      <li><a href="#noMenu">감민호장학금</a></li>
              ...
              <li>
                <a href="/math/community/notice.do">커뮤니티</a>
                ...
                <ul class="dep2">
                  ...
                  <li>
                    ...
                    <a href="/math/community/notice.do">수학과공지사항</a>
                  ...
                  <li>
                    ...
                    <a href="/math/community/job.do">취업게시판</a>
                  ...
                  <li>
                    ...
                    <a href="/math/community/seminars.do">세미나 및 강연회</a>
              ...
              <li>
                ...
                <ul class="dep2">
                  ...
                  <li>
                    ...
                    <a href="/math/online/propose.do">취업신청</a>
                  ...
                  <li>
                    ...
                    <a href="/math/online/data.do">자료실</a>
                  ...
                  <li>
                    ...
                    <a href="/math/online/rooms.do">강의별 게시판</a>
                  ...
                  <li>
                    ...
                    <a href="/math/online/personel.do">정원외 수강신청</a>
                  ...
                  <li>
                    ...
                    <a href="/math/online/study.do">스터디룸신청 및 접수</a>
                  ...
                  <li>
                    ...
                    <a href="/math/online/scholarship.do">장학금신청 및 접수</a>
                  ...
                  <li>
                    ...
                    <a href="/math/online/lecturer.do">시간강사신청 및 접수</a>
      ...
      <div class="lnb-wrap">
        <div class="lnb">
          ...
          <ul class="lnb-menu">
            ...
            <li class="active">
              <a href="/math/etc/login.do" class="jwxe_5764 active">로그인</a>
            ...
            <!--<li class="">
              <a href="/math/etc/sitemap.do" class="jwxe_5765 ">사이트맵</a>
          ...
          <div class="navi-box">
            <div class="jwxe_navigator jw-relative" style="">
              <ul>
                <li>Home</li>
                <li>기타</li>
                <li><span style="font-weight:bold">로그인</span></li>
              </ul>
            </div>
          </div>
        </div>
...
//<![CDATA[
	var resth = '/_custom/cnu/resource/', isEditorImageUpload = '' == 'false'? false: true;
//]]>
          </script>
	...
	//<![CDATA[
		...
		function beforeSubmit(form) {
			...
			if($('#chk_id:checked').length > 0o              rm.member_id              value, {
    ...
    'd                          duration : 365, // n                ys 
		...
		$(funct                  ) {
			if($.readCookie('                  id')) {
				$(                hk't                'c hecked','checked');
				$('#member_i                  ue',$.readCokie('chk_id'));
			}
		});
	...
	//]]>           
            ...
            <div class="bn-login01 type01">
              <form id="loginForm" class="b-login-box" method="post" action="login_action.php" onsubmit="return beforeSubmit(this);"
                autocomplete="off">
                <fieldset class="b-login-zone">
                  ...
                  <input type="hidden" name="siteId" value="math" />


                  <div class="b-login-input-wrap">
                    <label for="member_id" class="id hide">아이디</label>

                    <input type="text" id="member_id" name="id" title="아이디" placeholder="아이디" />
                    <label for="member_pw" class="pw hide">비밀번호</label>
                    <input type="password" id="member_pw" name="pwd" title="비밀번호" placeholder="비밀번호" />
                  </div>
              ...
              <div class="b-login-txt-box">
                ...
                <p>홈페이지 비밀번호는 포털 비밀번호와 같습니다.<br />
                  <span class="b-txt-c222 b-mg-r5">비밀번호 수정은 포털 → 통합정보시스템 → 상단 오른쪽 개인설정에서 변경하시기 바랍니다.</span>
                  <a href="http://portal.cnu.ac.kr/" title="포털사이트 바로가기" target="_blank" class="b-login-lnk">포털사이트
                    바로가기</a>
                </p>
                <p class="b-login-mark-p type02 b-mg-b20">비밀번호를 모르실 때는 포털에서 비밀번호 초기화를 이용하시기 바랍니다.</p>
                <p>
        ...
        <div class="bottom-footer-box">
          ...
          <div class="footer-info-box">
            <div class="footer-logo-wrap">
              <div>
                <p>
                  <img src="/_res/math/img/common/foot-logo-g.png" alt="충남대학교">
                </p>
                <div>
                  <img src="/_res/math/img/common/logo-cnu-text-g.png" alt="충남대학교">
                  <span>수학과</span>
                </div>
              </div>
            </div>
