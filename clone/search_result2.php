        ...
        <div class="content" id="jwxe_main_content">
          ...
          <div class="ko board list co-board type01">
            ...
            <div class="college_notice">
              ...
              $query = "SELECT * FROM board2 ORDER BY board_no DESC"; //역순 출력
              ...
              <div class="bn-search01 type01">
                <form method="get" action="search_result2.php">
...
<option value="contents">내용</option>
              ...
              <div class="bn-list-common01 type01 bn-common">
                ...
                <table summary="공지사항" class="board-table">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td class="etc" align="left"><a href="read2.php?board_no=<?php echo $rows['board_no'] ?>">
                          <?php echo $rows['title']; ?>
                      </td>
                ...
                <div id="page_num" style="text-align: center;">
                  <?php
                  if ($page <= 1) {
                    echo "<a href='board2.php?page=1'>◀  이전</a>";
                  } else {
                    $pre = $page - 1;
                    echo "<a href='board2.php?page=$pre'>◀  이전</a>";
                  }
                  for ($i = $block_start; $i <= $block_end; $i++) {
                    if ($page == $i) {
                      echo "<b> $i </b>";
                    } else {
                      echo "<a href='board2.php?page=$i'> $i</a>";
                    }
                  }
                  if ($page >= $total_page) {
                    //빈값
                    ...
                    $next = $page + 1;
                    echo "<a href='board2.php?page=$next'>다음  ▶</a>";
                  }
                  if ($page >= $total_page) {
                    //빈 값
                  } else {
                    echo "<a href='board2.php?page=$total_page'> 마지막</a>";
                  }
                  ?>
                </div>
