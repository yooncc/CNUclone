      ...
      <div class="lnb-wrap">
        <div class="lnb">
          ...
          <ul class="lnb-menu">
            ...
            <li class="active">
              <a href="board1.php" class="jwxe_5745 active">공지사항</a>
        ...
        <div class="content" id="jwxe_main_content">
          ...
          <div class="ko board list co-board type01">
            ...
            <div class="college_notice">
              ...
              $query = "SELECT * FROM board1 ORDER BY board_no DESC"; //역순 출력
              ...
              //게시글 정보 가져오기
              $result = mysqli_query($connect,"SELECT * FROM board1 where $category like '%{$search}%' ORDER BY board_no DESC LIMIT $page_start, $list");
              ?>


              <!--검색창 시작-->
              <div class="bn-search01 type01">
                <form method="get" action="search_result1.php">
...
<option value="contents">내용</option>
              ...
              <div class="bn-list-common01 type01 bn-common">
                ...
                <table summary="공지사항" class="board-table">
                  ...
                  <tbody>
                    ...
                    <tr>
                      ...
                      <td class="etc" align="left"><a href="read1.php?board_no=<?php echo $rows['board_no'] ?>">
                          <?php echo $rows['title']; ?>
                      </td>
                ...
                <div id="page_num" style="text-align: center;">
                  <?php
                  if ($page <= 1) {
                    echo "<a href='board1.php?page=1'>◀  이전</a>";
                  } else {
                    $pre = $page - 1;
                    echo "<a href='board1.php?page=$pre'>◀  이전</a>";
                  }
                  for ($i = $block_start; $i <= $block_end; $i++) {
                    if ($page == $i) {
                      echo "<b> $i </b>";
                    } else {
                      echo "<a href='board1.php?page=$i'> $i</a>";
                    }
                  }
                  if ($page >= $total_page) {
                    //빈값
                    ...
                    $next = $page + 1;
                    echo "<a href='board1.php?page=$next'>다음  ▶</a>";
                  }
                  if ($page >= $total_page) {
                    //빈 값
                  } else {
                    echo "<a href='board1.php?page=$total_page'> 마지막</a>";
                  }
                  ?>
                </div>
    ...
    <div class="bottom-footer-wrap">
      <div class="bottom-footer-box">
        <div class="footer-ul-wrap">
          ...
          <ul class="footer-ul">
            <li><a href="index.php" title="충남대학교 포털 새창열림" >충남대학교 포털</a></li>
            <li><a href="index.php" title="충남대학교 개인정보 처리방침 새창열림"
                >개인정보 처리방침</a></li>
            <li><a href="index.php" title="충남대학교 이메일무단수집거부 새창열림"
                >이메일무단수집거부</a></li>
          </ul>
        </div>
