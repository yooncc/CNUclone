...
$query = "SELECT title, contents, user_id, updated_time, file, name from board3 where board_no = $number";
...
<form method="POST" action="modify_action3.php" enctype="multipart/form-data">
