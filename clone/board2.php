        ...
        <div class="content" id="jwxe_main_content">
          ...
          <div class="ko board list co-board type01">
            ...
            <div class="college_notice">
              ...
              //게시글 정보 가져오기
              $result = mysqli_query($connect, "SELECT * FROM board2 ORDER BY board_no DESC LIMIT $page_start, $list");
              ?>
              ...
              <div class="bn-list-common01 type01 bn-common">
                ...
                <div id="page_num" style="text-align: center;">
                  ...
                  if ($page >= $total_page) {
                    ...
                    $next = $page + 1;
                    echo "<a href='board.php2?page=$next'>다음  ▶</a>";
                  }
                  if ($page >= $total_page) {
                    //빈 값
                  } else {
                    echo "<a href='board.php2?page=$total_page'> 마지막</a>";
                  }
                  ?>
                </div>
